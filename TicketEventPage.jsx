...
function TicketEventPage() {
  ...
  const handleCancel = () => {
    if (buttonText === "Cancel Tickets") {
      setShowCancelConfirm(true); // Show confirmation box
      console.log("Cancel complete\n");
    }
  };
  
  const handleCancelConfirm = () => {
    setShowCancelConfirm(false); // Hide confirmation box
        ...
        <div className="ticket-event-page__cols__container">
          ...
          <div className="ticket-event-page__right__col">
            <nav>
                ...
                <div className="ticket-event-page__dropdown-menu" onClick={handleBooking}>
                  <div className="ticket-event-page__dropdown-content" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="ticket-event-page__dropdown-agreement">
                      ...
                      <p>I agree with the Terms and Conditions of the Suki Event Management Platform and am responsible for the information provided in this form.</p>
                    </div>
              ...
              {showCancelDropdown && (
                <div className="ticket-event-page__dropdown-menu" onClick={handleCancel}>
                  <div className="ticket-event-page__dropdown-content" onClick={(e) => e.stopPropagation()}>
                    <div className="ticket-event-page__dropdown-input-wrapper"></div>
                    <div className="ticket-event-page__dropdown-agreement"></div>
                    <button
              ...
              {showCancelConfirm && (
                <div className="ticket-event-page__cancel-confirm">
                  <p>Do you want to cancel tickets?</p>
                  <button onClick={handleCancelConfirm} className="ticket-event-page__cancel-confirm-button">
                    Cancel Tickets
                  </button>
                  <button onClick={() => setShowCancelConfirm(false)} className="ticket-event-page__cancel-confirm-button">
                    Close
                  </button>
                </div>
              )}

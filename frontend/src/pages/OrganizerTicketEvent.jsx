...
//   };
  ...
  return (
    <div className="organizer-ticket-event-page__maincontainer">
      <NavBar />
      <div className="organizer-ticket-event-page__header__wrapper">
        <div style={headerStyle}></div>
        <div className="organizer-ticket-event-page__cols__container">
          <div  className="organizer-ticket-event-page__left__col" ref={leftColRef}>
            <div className ="organizer-ticket-event-page__layer">
            <div className="organizer-ticket-event-page__img__container">
              <div className="organizer-ticket-event-page__round">
                <img src={infoEvent.logoUrl} alt="User img" />
              </div>
              <span></span>
            </div>
            <div className="organizer-ticket-event-page__name-container">
              <h2>{infoEvent.eventname}</h2>
            </div>
            <div className="organizer-ticket-event-page__information-container">
              <p>{infoEvent.descriptionevent}
              </p>
            </div>

            <div className="organizer-ticket-event-page__follow">
              <button onClick={handleManageText} >{manageText}</button>
            </div>
            <ul className="organizer-ticket-event-page__about">
              <li>
            ...
            <ul className = "organizer-ticket-event-page__remain-info">
            ...
            <div className = "organizer-ticket-event-page__rule-container">
                <p>Rule</p>
                <ul>
                  <li>Rule1</li>
                  <li>Rule2</li>
          ...
          <div className="organizer-ticket-event-page__right__col" >
            <nav>
              <ul>
                <li>
                  <a>Posts</a>
            ...
            <div className="organizer-ticket-event-page__container-post">
              <MyPostWidget />
...
export default OrganizerTicketEvent;

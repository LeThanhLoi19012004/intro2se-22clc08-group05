    ...
    return (
      <div className="searchpage__left-side">
        ...
        <div 
          ...
          style={{ cursor: "pointer" }}
        >
          <span className="searchpage__icon"><FaCog className = "icon" style = {{color: isSettingsClicked ? '#ff7383' :'#2d158f'}}/></span>
          <span className="searchpage__text" style = {{color: isSettingsClicked ? '#ff7383' :'#2d158f'}}>Settings</span>
        </div>
        <div className="searchpage__menu-gap"></div>
          <Link to="/createvent" className="searchpage__menu-item-create"
            onClick={handleClickCreateEvent}
            style={{ cursor: "pointer" }}
          >
            <span className="searchpage__icon"><FaRegCalendarAlt className ="icon"/></span>
            <span className="searchpage__text">Create Event</span>
          </Link>
        </div>
    );
}

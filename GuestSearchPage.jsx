...
function AbstractObjects() {
    return (
        <div className="guest-searchpage__abstract-objects">
            ...
            <img src={Polygon1} className="guest-searchpage__first-section-polygon-1"/>
            <img src={Ellipse2} className="guest-searchpage__first-section-ellipse-2"/>
            <img src={Ellipse1} className="guest-searchpage__first-section-ellipse-1"/>
            <img src={Ellipse3} className="guest-searchpage__first-section-ellipse-3"/>
            <img src={Polyline1} className="guest-searchpage__first-section-polyline-1"/>
    ...
    return (
        <div className="guest-searchpage__result">
            ...
            <div className="guest-searchpage__result_content">
                <div class="guest-searchpage__result_content-event-name">{props.authorName}</div>
                <div class="guest-searchpage__result_content-event-type">{props.content}</div>
            </div>
        </div>
    );
}
    ...
    useEffect(() => {
        const filterEvents = () => {
            const filtered = events.filter(event => {
                ...
                const matchesQuery = event.eventname.toLowerCase().includes(searchQueryGuest);
            ...
            <header className="guest-searchpage__header">
                ...
                <div className="guest-searchpage__header-right-section">
                    <ul className="guest-searchpage__header-navigation-bar">
                        <Link className="guest-searchpage__header-navigation-bar-button-here">SEARCH</Link>
                        <Link to="/" className="guest-searchpage__header-navigation-bar-button">HOME</Link>
                        <Link to="/aboutus" className="guest-searchpage__header-navigation-bar-button">ABOUT</Link>
                        <Link to="/login" className="guest-searchpage__header-navigation-bar-button">LOGIN</Link>
                        <Link to="/signup" className="guest-searchpage__header-navigation-bar-button">SIGN UP</Link>
                    </ul>
                </div>
            </header>
                    ...
                    <div className="guest-searchpage__sidebar">
                        <div className="guest-searchpage__filter-section">
                                ...
                                <ul className="guest-searchpage__category-list">
                                    {categories.map((category, index) => (
                                        <li key={index} className="guest-searchpage__category-item">
                                            ...
                                            />
                                            <label htmlFor={`guest-searchpage__category-${index}`} className="guest-searchpage__label">
                                                {category}
                                            </label>
                                        </li>
                                    ))}
                            ...
                            <div className="guest-searchpage__date">
                                ...
                                <label htmlFor="guest-searchpage__start-date" className="guest-searchpage__label">Start Date </label>
                                <div className="guest-searchpage__datepicker-container">
                                    ...
                                    />
                                    <button type="button" className="guest-searchpage__clear-button" onClick={clearStartDate}>Clear</button>
                                </div>
                                <label htmlFor="guest-searchpage__end-date" className="guest-searchpage__label">End Date</label>
                                <div className="guest-searchpage__datepicker-container">
                                    <DatePicker
                                        id="end-date"
                                        selected={endDate}
                                        ...
                                        minDate={startDate}
                                    />
                                    <button type="button" className="guest-searchpage__clear-button" onClick={clearEndDate}>Clear</button>
                                </div>
                            </div>

...
import "../assets/ParticipantEventPage.css";
...
function ParticipantEventPage() {
  ...
  const handleFollowedText = () =>{
    if(followedText === "Follow"){
      ...
      setFollowButtonBackGround("#2d158f");
  ...
  return (
    <div className="participant-event-page__maincontainer">
      <NavBar />
      <div className="participant-event-page__header__wrapper">
        <div style={headerStyle}></div>
        <div className="participant-event-page__cols__container">
          <div  className="participant-event-page__left__col" >
            <div className ="participant-event-page__layer">
            <div className="participant-event-page__img__container">
              <div className="participant-event-page__round">
                <img src={infoEvent.logoUrl} alt="User img" />
              </div>
              <span></span>
            </div>
            <div className="participant-event-page__name-container">
              <h2>{infoEvent.eventname}</h2>
            </div>
            <div className="organizer-ticket-event-page__upper-part">
              <div className="participant-event-page__information-container">
                <p>{infoEvent.descriptionevent}
                </p>
              </div>
              <div className="participant-event-page__follow">
              <button onClick={handleFollowedText} style={{ background: followButtonBackGround }}>{followedText}</button>
              </div>
              <ul className="participant-event-page__about">
                <li>
              ...
              <ul className = "participant-event-page__remain-info">
            ...
            <div className = "participant-event-page__rule-container">
                <p>Rule</p>
                <ul>
                  <li>Rule1</li>
                  <li>Rule2</li>
          ...
          <div className="participant-event-page__right__col" >
            <nav>
              <ul>
                <li>
                  <a>Posts</a>
              ...
              <button onClick={handleJoin} className = "booking-button" style = {{background:joinBackground}}>{joinText}</button>
              {/* {showDropdown && (
                <div className="participant-event-page__dropdown-menu" onClick={handleBooking}>
                  <div className="participant-event-page__dropdown-content" onClick={(e) => e.stopPropagation()}>
                    <div className="participant-event-page__dropdown-input-wrapper">
                      <label className="participant-event-page__dropdown-label" htmlFor="booking-amount">Amount:</label>
                      <input
                        type="number"
                        id="booking-amount"
                        placeholder="Booking Amount"
                        className="participant-event-page__dropdown-input"
                        value={amount}
                        onChange={handleAmountChange}
                      />
                    </div>
                    <div className="participant-event-page__dropdown-agreement" >
                      <label htmlFor="agree">
                      <svg 
                        className={`participant-event-page__checkbox ${
                          isChecked ? "participant-event-page__checked--active" : ""
                        }`}
                        aria-hidden="true"
                        viewBox="0 0 15 11"
                        fill="none"
                    ...
                    <div className="participant-event-page__dropdown-timer">Time left: {formatTime(timeLeft)}</div>
                    <button
                      onClick={handleBooking}
                      disabled={disabledBooking}
                      className="participant-event-page__dropdown-buy-button"
                    >
                      Buy Tickets
                    </button>
                  </div>

        ...
        <div className="event-page__cols__container">
          <div className="event-page__left__col">
            ...
            <div className="event-page__information-container">
              <p>
                bla bla hello my name is thuan ngu thuan ngu thuan ngu thuan ngu
                thuan ngu thuan ngu thuan nug nthua nthug sndf sndf sduf sdfsnd
                sdf sndf sn fsdj fns
              </p>
            </div>

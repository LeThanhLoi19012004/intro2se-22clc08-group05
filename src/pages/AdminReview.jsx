    ...
    useEffect(() => {
        ...
        const fetchEventData = async () => {
            ...
            if (response.success){
                ...
                setImage(`data:${response.data.logoevent.contentType};base64,${response.data.logoevent.imageBase64}`);
        ...
        <>
            <div className="admin-review__container">
                ...
                <div className="admin-review__form">
                    ...
                    <div id="event-name" className="data-field">{eventData.eventname}</div>

...
function Setting() {
  ...
  return (
    <div className="settingpage-account">
      <div className="settingpage-account-header">
        <h1 className="settingpage-account-title">Settings</h1>
      </div>
      <div className="settingpage-setting-content">
        ...
        <div className="settingpage-setting-item">
          ...
          <button className="settingpage-button delete">Delete</button>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="settingpage-account">
      ...
      <div className="settingpage-logout-content">
        ...
        <button className="settingpage-account-button" onClick={handleLogout}>Log out</button>
      </div>
    </div>
  );
}

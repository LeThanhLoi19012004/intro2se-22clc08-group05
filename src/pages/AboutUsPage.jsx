                ...
                <div className="about-us__card">
                    ...
                    <div className="about-us__story-container">
                        ...
                        <div className="about-us__story-text">
                            <span>The Story</span>
                            <p className="p-1">
                                <strong>Suki Event Management Platform</strong> was created out of a passion for creating
                                unforgettable experiences and simplifying the event planning process.
                                We believe everyone should have access to events, regardless of their planning experience.
                            </p>
                            <p className="p-2">
                                We handmade <strong>Suki</strong>, a user-friendly <strong>event management platform </strong>
                                designed with you in mind. Whether you're an event organizer bringing your vision to life,
                                or an attendee seeking incredible experiences, <strong>Suki</strong> always empowers you.
                            </p>
                        </div>
                    </div>
                    <div className="about-us__team-container">
                        <div className="about-us__team-text">
                            <span>The Team</span>
                            <p className="p-1">
                                We are <strong>EVE</strong>, the fifth group in our university class, <strong>22CLC08</strong>.
                                This is a project created by us for our Course of <strong>Introduction to Software Engineering. </strong>
                                Throughout this project, we have learned a lot of new concepts and ideas,
                                and we are confident to bring this event management platform to life.
                            </p>
                            <p className="p-2">
                                Our team consists of <strong>five</strong> people: Lâm Tiến Huy, Lê Thành Lợi,
                                Trịnh Quốc Hiệp, Nguyễn Trọng Nhân, and Kha Vĩnh Thuận.
                                Each person in our team is very committed to this project,

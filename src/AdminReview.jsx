...
function AbstractFigures(){
    return(
        <>
        <span className = "admin-review__abstract-container">
            
            <div className = "admin-review__gradient-smudge"></div>
            <div className = "admin-review__gradient-smudge"></div>
        </span>
        </>
    );
...
function AdminReview(){
    ...
    useEffect(() => {
        ...
        // const submitButton = document.getElementById('admin-review-approve');
        // const imgContainer = document.getElementById('admin-review__img-container');
    ...
    const handleApprove = () => {
        ...
        setActiveButton("approve"); // Show only the "Reject" button
    };
    ...
    const handleReject = () => {
        ...
        setActiveButton("reject"); // Show only the "Approve" button
    };
    return(
        <>
